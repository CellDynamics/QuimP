/*
*   BoxURSymbol  -- Represents a square plot symbol with the upper right corner cut out.
*
...
*      the upper right corner removed.
*  </p>
*
...
**/
public class BoxURSymbol extends PolygonSymbol {
	...
	//-------------------------------------------------------------------------
	/**
	*  Creates a square with UR corner removed plot
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		xPoints[2] = xpw2;		yPoints[2] = ypw2;
		xPoints[3] = xpw2;		yPoints[3] = y;
		xPoints[4] = x;			yPoints[4] = ymw2;
