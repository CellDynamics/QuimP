/*
*   TabDSymbol  -- Represents a tab pointing down plot symbol.
*
...
/**
*  <p> This class represents a tab pointing down
*      plot symbol.
*  </p>
*
...
**/
public class TabDSymbol extends PolygonSymbol {
	...
	//-------------------------------------------------------------------------
	/**
	*  Creates a tab pointing down plot
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		xPoints[2] = xmw2;			yPoints[2] = y;
		xPoints[3] = x;				yPoints[3] = y + width2;
		xPoints[4] = xpw2;			yPoints[4] = y;
