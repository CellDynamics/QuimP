/*
*   Triangle1Symbol  -- Represents an upright triangle plot symbol.
*
...
/**
*  <p> This class represents an upright triangle shaped plot
...
**/
public class Triangle1Symbol extends PolygonSymbol {
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		xPoints[1] = x - width2;	yPoints[1] = y + width2;
		xPoints[2] = x + width2;	yPoints[2] = y + width2;
