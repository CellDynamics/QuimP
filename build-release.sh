...
java -jar Doxygen_doc/plantuml.jar "target/checkout/src/main/java/uk/ac/warwick/wsbc/QuimP/**.java"
# go to released version
cd target/checkout
# generate javado again but now with images
mvn javadoc:jar
# generate site
mvn site
cd ../../
