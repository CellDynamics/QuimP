...
public class ExtendedVector2d extends Vector2d {
	 ...
	 */
	@Deprecated
	public static ExtendedVector2d lineIntersectionOLD(ExtendedVector2d nA1, ExtendedVector2d nA2, ExtendedVector2d nB1, ExtendedVector2d nB2) {
		...
		cp = new ExtendedVector2d((bA * cB - bB * cA) / denom, (aB * cA - aA * cB) / denom); //intersection point
	...
	/**
	 * @copydoc lineIntersectionOLD(ExtendedVector2d, ExtendedVector2d, ExtendedVector2d, ExtendedVector2d)
	 */
	@Deprecated
	public static ExtendedVector2d lineIntersectionOLD2(ExtendedVector2d nA1, ExtendedVector2d nA2, ExtendedVector2d nB1, ExtendedVector2d nB2) {
