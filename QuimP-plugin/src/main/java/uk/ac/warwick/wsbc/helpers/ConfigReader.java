 ...
 * 
 * The config file is in JSON format and contains two levels of data.
 * On main level there is name of plugin whereas on nested level there is a list
 * of named parameters for that plugin, e.g.
 * @code
 * {
 *	"MeanFilter": {
 *		"window": "11"
...
public class ConfigReader {
	...
	/**
	 * Return raw (as \c String) parameter read from \a pluginName : \a paramName
	 * 
	 * @param pluginName Name of the plugin listed in read configuration file
	 * @param paramName Name of the plugin parameter listed in read configuration file
	 * @return String representation of parameter read from configuration file
	 * @throws ConfigReaderException On any error (usually bad names)
	 */
	...
	/**
	 * Return converted (as \c int) parameter read from \a pluginName : \a paramName
	 * 
	 ...
	 * @throws ConfigReaderException  On any error (usually bad names or bad conversion)
	 */
	...
	/**
	 * Return converted (as \c double) parameter read from \a pluginName : \a paramName
	 * 
