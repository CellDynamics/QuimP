 ...
 * 
 * @code { "MeanFilter": { "window": "11" } "LoesFilter": { "smooth": "1.1e-3" }
 *       "HatFilter": { "mask": "23", "inner": "11", "sigma": "1e-4" } }
 * @endcode All parameters are named from small letters ant those names must be
 ...
 * @code{.java} // set params ConfigReader cR = new
 *              ConfigReader(System.getProperty("user.home")+System.getProperty(
 *              "file.separator")+"plugin.json"); HashMap<String,Object> map =
 *              new HashMap<String,Object>(); map.put("window",
...
public class ConfigReader {
     ...
     * 
     * @param pluginName
     *            Name of the plugin listed in read configuration file
     * @param paramName
     *            Name of the plugin parameter listed in read configuration file
