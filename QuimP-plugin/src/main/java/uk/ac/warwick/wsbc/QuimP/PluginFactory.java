...
public class PluginFactory {
    ...
    /**
     * Scan directory and stores results in array <name,<path,type>> Name is
     * usually file name without decorations
     */
     ...
     * 
     * @param type
     *            Type defined in uk.ac.warwick.wsbc.plugin.IQuimpPlugin
