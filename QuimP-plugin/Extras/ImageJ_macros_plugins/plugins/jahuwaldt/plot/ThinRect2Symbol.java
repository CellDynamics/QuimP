/*
*   ThinRect2Symbol  -- Represents a horizontal thin rectangle plot symbol.
*
...
/**
*  <p> This class represents a horizontal thin rectangle
*      plot symbol.
*  </p>
*
...
**/
public class ThinRect2Symbol extends PolygonSymbol {
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		//	Determine points.
		xPoints[0] = xpw2;			yPoints[0] = ymw4;
		xPoints[1] = xmw2;			yPoints[1] = ymw4;
		xPoints[2] = xmw2;			yPoints[2] = ypw4;
		xPoints[3] = xpw2;			yPoints[3] = ypw4;
