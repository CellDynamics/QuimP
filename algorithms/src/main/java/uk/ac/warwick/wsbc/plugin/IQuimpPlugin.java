...
public interface IQuimpPlugin {
	 ...
	 * 
	 * This method is used for restoring configuration from config
	 * files maintained by caller. Caller do not modify these values and
	 * only stores them as the were returned by getPluginConfig() method.
	 * 
	 * @remarks
	 * Numerical values should be passed as Double
	 * @warning
	 * setPluginConfig(HashMap<String,Object>) and getPluginConfig()
	 * should use the same convention of key naming and parameters casting
	 * @param par
