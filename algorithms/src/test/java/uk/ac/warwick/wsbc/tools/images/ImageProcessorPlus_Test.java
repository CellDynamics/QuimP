...
public class ImageProcessorPlus_Test {
	...
	/**
	 * @test
	 * Test method for {@link uk.ac.warwick.wsbc.tools.images.ImageProcessorPlus#rotate(ImageProcessor, double, boolean)}.
	 * @post
	...
	/**
	 * @test
	 * Test method for {@link uk.ac.warwick.wsbc.tools.images.ImageProcessorPlus#rotate(ImageProcessor, double, boolean)}. with background settings
	 * @post
	 * Rotated image should have bas-reliefs oriented horizontally. Saves rotated image to /tmp/testrotateImage.tif. 
	...
	/**
	 * @test
	 * Test method for {@link uk.ac.warwick.wsbc.tools.images.ImageProcessorPlus#extendImageBeforeRotation(ImageProcessor, double)}.
	 * @post
