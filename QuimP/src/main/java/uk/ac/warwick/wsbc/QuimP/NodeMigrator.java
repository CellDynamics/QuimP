...
public class NodeMigrator {
    ...
    //
    // if (ECMp.ANA) {
    // //v.floures += ECMp.image.getPixelValue((int)Math.round(p.getX()),
    // (int)Math.round(p.getY())); // average
    //
    // // tempFlu = ECMp.image.getPixelValue(x, y) + ECMp.image.getPixelValue(x
    // - 1, y)
    // // + ECMp.image.getPixelValue(x + 1, y) + ECMp.image.getPixelValue(x, y -
    // 1)
    ...
    // Vert v = s.getTarStart();
    // do {
    // double d = Vect2d.distPointToSegment(p, v.getPoint(),
    // v.getNext().getPoint());
    ...
    // intersect pount
    // distance = Vect2d.distPointToSegment(p, v.getPoint(),
    // v.getNext().getPoint());
    // v = v.getNext();
    // closest = v.getPoint();
    // closestEdge = v;
    ...
    // double tempFlu = ECMp.image.getPixelValue(x, y) +
    // ECMp.image.getPixelValue(x - 1, y)
    ...
    // + ECMp.image.getPixelValue(x + 1, y+1) + ECMp.image.getPixelValue(x+1, y
    // - 1)
