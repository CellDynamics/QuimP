/*
*   RTriangle2Symbol  -- Represents a right triangle plot symbol, upper right.
*
...
*      the 90 degree corner in the upper right.
*  </p>
*
...
public class RTriangle2Symbol extends PolygonSymbol {
	...
	//-------------------------------------------------------------------------
	/**
	*  Creates a right triangle with 90 deg angle in upper right corner plot
	*  symbol that has a width of 8 pixels, is transparent and
	*  has a border color of black.
	**/
	public RTriangle2Symbol() {}
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		//	Determine points.
		xPoints[0] = x - width32;		yPoints[0] = ymw3;
		xPoints[1] = xpw3;				yPoints[1] = y + width32;
		xPoints[2] = xpw3;				yPoints[2] = ymw3;
