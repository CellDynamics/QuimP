/*
*   Triangle2Symbol  -- Represents a triangle plot symbol pointing right.
*
...
**/
public class Triangle2Symbol extends PolygonSymbol {
	...
	//-------------------------------------------------------------------------
	/**
	*  Creates a triangle plot symbol pointing to the right
	*  that has a width of 8 pixels, is transparent and
	*  has a border color of black.
	**/
	public Triangle2Symbol() {}
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		xPoints[1] = xmw2;			yPoints[1] = y + width2;
