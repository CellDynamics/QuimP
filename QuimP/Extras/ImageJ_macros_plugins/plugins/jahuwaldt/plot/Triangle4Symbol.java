/*
*   Triangle4Symbol  -- Represents a triangle plot symbol pointing left.
*
...
**/
public class Triangle4Symbol extends PolygonSymbol {
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		//	Determine points.
		xPoints[0] = xpw2;			yPoints[0] = y - width2;
		xPoints[1] = x - width2;	yPoints[1] = y;
		xPoints[2] = xpw2;			yPoints[2] = y + width2;
