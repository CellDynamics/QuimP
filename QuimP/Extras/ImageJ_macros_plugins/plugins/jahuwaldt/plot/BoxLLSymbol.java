/*
*   BoxLLSymbol  -- Represents a square plot symbol with the lower left corner cut out.
*
...
**/
public class BoxLLSymbol extends PolygonSymbol {
	...
	//-------------------------------------------------------------------------
	/**
	*  Creates a square with LL corner removed plot
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		xPoints[1] = xmw2;		yPoints[1] = y;
		xPoints[2] = x;			yPoints[2] = ypw2;
		xPoints[3] = xpw2;		yPoints[3] = ypw2;
