/*
*   TabRSymbol  -- Represents a tab pointing right plot symbol.
*
...
/**
*  <p> This class represents a tab pointing right
*      plot symbol.
*  </p>
*
...
**/
public class TabRSymbol extends PolygonSymbol {
	...
	//-------------------------------------------------------------------------
	/**
	*  Creates a tab pointing right plot
	...
	**/
	protected void generatePoints(int x, int y) {
		...
		//	Determine points.
		xPoints[0] = x;				yPoints[0] = ymw2;
		xPoints[1] = xmw2;			yPoints[1] = ymw2;
		xPoints[2] = xmw2;			yPoints[2] = ypw2;
		xPoints[3] = x;				yPoints[3] = ypw2;
		xPoints[4] = x + width2;	yPoints[4] = y;
