/*
*   BoxULSymbol  -- Represents a square plot symbol with the upper left corner cut out.
*
...
public class BoxULSymbol extends PolygonSymbol {
	...
	//-------------------------------------------------------------------------
	/**
	*  Creates a square with UL corner removed plot
