...
public class SeedProcessorTest {
  ...
  /**
   * Test of {@link SeedProcessor#decodeSeedsfromRoi(List, String, String, int, int)}.
   * 
   * @throws Exception Exception
   */
  @Test
  public void testDecodeSeedsfromRoi() throws Exception {
    String fgcore = "fg";
    String bgcore = "bg";
    ...
    Seeds ret = SeedProcessor.decodeSeedsfromRoi(rois, fgcore, bgcore, 128, 128);
  ...
  /**
   * Test of {@link SeedProcessor#seedsToGrayscaleImage(Seeds)}.
   * 
   * @throws Exception Exception
   */
  @Test
  public void testSeedsToGrayscaleImage() throws Exception {
    String fgcore = "fg";
    String bgcore = "bg";
    Roi l1 = new Line(0, 0, 10, 0); // 11 pixels
    l1.setName(fgcore + "0_0");
    ...
    Seeds seeds = SeedProcessor.decodeSeedsfromRoi(rois, fgcore, bgcore, 128, 128);

    ImageProcessor ret = SeedProcessor.seedsToGrayscaleImage(seeds);
  ...
  /**
   * Test of {@link SeedProcessor#decodeSeedsfromGrayscaleImage(ImageProcessor)}.
   * 
   * @throws Exception Exception
   */
  @Test
  public void testDecodeSeedsfromGrayscaleImage() throws Exception {
    ImageProcessor test = new ByteProcessor(128, 256);
    test.putPixel(5, 10, 1);
    test.putPixel(10, 20, 2);
    test.putPixel(20, 30, 4);

    Seeds ret = SeedProcessor.decodeSeedsfromGrayscaleImage(test);
   ...
   */
  @Test
  public void testDecodeSeedsfromGrayscaleImage_1() throws Exception {
  ...
  /**
   * Test method for
   * {@link SeedProcessor#decodeSeedsfromRoiStack(List, String, String, int, int, int)}.
   * 
   * <p>Similar to
   * {@link com.github.celldynamics.quimp.plugin.randomwalk.SeedProcessorTest#testDecodeSeedsfromRoi()}
   * 
   * @throws Exception Exception
   * 
   */
  @Test
  public void testDecodeSeedsfromRoiStack() throws Exception {
    String fgcore = "fg";
    String bgcore = "bg";
    Roi l1 = new Line(0, 0, 10, 0); // 11 pixels
    l1.setName(fgcore + "0_0");
    ...
    // check for one slice
    List<Seeds> r = SeedProcessor.decodeSeedsfromRoiStack(rois, fgcore, bgcore, 128, 128, 1);
    Seeds ret = r.get(0);
