...
public class SerializerVersioning {
    ...
    public void testScenario1()
            throws JsonSyntaxException, JsonIOException, IOException, Exception {
        // save old version
        ...
        TestClass_newer obj;
        Serializer<TestClass_newer> sl = new Serializer<>(TestClass_newer.class,
                new QuimpVersion("1.2.0", "stamp", "quimp"));
...
class TestClass_newer implements IQuimpSerialize {
    ...
    public String toString() {
        return "TestClass_newer [a=" + a + ", b=" + b + ", c=" + c + ", d=" + d + ", e=" + e
                + ", f=" + f + "]";
    }
