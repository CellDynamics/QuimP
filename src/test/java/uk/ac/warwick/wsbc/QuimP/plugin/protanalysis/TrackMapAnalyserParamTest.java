...
public class TrackMapAnalyserParamTest {
    ...
    public static Collection<Object[]> data() {
        ...
        // One common point
        {
            ...
            ret.add(new Object[] { Type.INTERSECTION, track, expIntersectionPoints,
                    expIntersectionPairs, TrackMapAnalyser.WITH_SELFCROSSING });
        }
        // no intersect
        ...
        // three tracks - each cross each
        {
            ...
            Polygon expIntersectionPoints =
                    new Polygon(new int[] { 6, 5, 9 }, new int[] { 5, 5, 9 }, 3);
            @SuppressWarnings("serial")
            List<Pair<Point, Point>> expIntersectionPairs = new ArrayList<Pair<Point, Point>>() {
                {
                    add(new Pair<Point, Point>(new Point(0, 1), new Point(5, 5)));
        ...
        // intersection without selfcrossing
        {
            ...
            ArrayList<Polygon> track =
                    test(new Object[] { x1, y1 }, new Object[] { x2, y2 }, new Object[] { x3, y3 });
            Polygon expIntersectionPoints =
                    new Polygon(new int[] { 5, 400 }, new int[] { 5, 7 }, 2);
            @SuppressWarnings("serial")
            List<Pair<Point, Point>> expIntersectionPairs = new ArrayList<Pair<Point, Point>>() {
                {
            ...
            ret.add(new Object[] { Type.INTERSECTION, track, expIntersectionPoints,
                    expIntersectionPairs, TrackMapAnalyser.WITHOUT_SELFCROSSING });
        }
        ...
        // Repeatings One self intersection
        {
            ...
            ret.add(new Object[] { Type.REPEATING, track, expIntersectionPoints,
                    expIntersectionPairs, TrackMapAnalyser.WITH_SELFCROSSING });
        }
        // no intersection
        {
        ...
        // point from backtrack
        {
            ...
            ret.add(new Object[] { Type.ENUMERATE, track, expIntersectionPoints,
                    expIntersectionPairs, 0 });
        }
