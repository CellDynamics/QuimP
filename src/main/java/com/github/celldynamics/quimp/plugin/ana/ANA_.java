...
public class ANA_ implements PlugInFilter, DialogListener {
  ...
  private boolean plotOutlines = false; // UI setting. Plot outlines on the end
  ...
  public void run(ImageProcessor imageProcessor) {
    ...
    try {
      ...
      qe.handleException(IJ.getInstance(), "ANA module failed due to following error:");
    } catch (Exception e) {
  ...
  private boolean anaDialog() {
    ...
    pd.addCheckbox("New image with outlines? ", plotOutlines);
  ...
  public boolean dialogItemChanged(GenericDialog gd, AWTEvent e) {
    ...
    plotOutlines = ((Checkbox) gd.getCheckboxes().elementAt(3)).getState();
