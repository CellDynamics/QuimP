 ...
 * 
 * <p>Assumes that string contains list of parameters separated by commas. Any white character are
...
public class StringParser {
   ...
   * 
   * <p>Simply return number of commas in input string. Does not check other conditions.
   * 
   ...
   */
  public static int getNumofParam(final String s) {
    if (s.isEmpty()) {
      return 0;
    } else {
   ...
   * 
   */
  public static String[] getParams(final String s) {
    if (s.isEmpty()) {
      return new String[0];
    }
    String l = s.replaceAll("\\s+", ""); // get rid with white spaces
