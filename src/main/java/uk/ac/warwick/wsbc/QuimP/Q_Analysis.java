 ...
 * 
 * In principle this object loads and process name_X.paQP file generated by ECMM. \a X in this case
 ...
 * of methods operate on current status private fields (such as \c qp, \c oH). The main analysis
 * runner method is \c run(), whereas support for both input formats is covered by \c runFromPAQP()
 * and \c runFromQCONF() (similarly to @ref uk.ac.warwick.wsbc.QuimP.ECMM_Mapping "ECMM_Mapping") 
 *  
 * @author rtyson
